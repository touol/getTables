<div class="form-inline get-table-nav">
    ...
    <select name="limit" id="getLimit_{$name}" class="form-control input-sm">
        <option value="10" {if $page.limit == 10}slected{/if}>10</option>
        <option value="20" {if $page.limit == 20}slected{/if}>20</option>
        <option value="40" {if $page.limit == 40}slected{/if}>40</option>
        <option value="60" {if $page.limit == 60}slected{/if}>60</option>
    </select>
